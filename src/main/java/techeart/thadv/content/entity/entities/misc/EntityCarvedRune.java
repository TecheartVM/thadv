...
public class EntityCarvedRune extends EntityDummy
{
    ...
    protected AABB makeBoundingBox()
    {
        ...
        return getType().getDimensions().makeBoundingBox(posCenter);
    }
    ...
    @Override
    protected float getEyeHeight(Pose pose, EntityDimensions dimensions) { return getType().getHeight() * 0.5f; }
